...
namespace Levantc\Traits\Stubs;
...
trait BuildsModuleTokens
{
    ...
    protected function buildModuleMap(string $moduleKey, array $moduleMeta = []): array
    {
        ...
        $moduleNamespace = (string) ($moduleMeta['namespace'] ?? ('Levantc\\'.Str::studly($moduleKey)));
        ...
        return [
            ...
            '{{moduleNamespace}}' => $moduleNamespace,  // Levantc\Geography
